...
class ButterflyPainter extends CustomPainter {
  ...
  Color _lineColor(double hueOffset, double opacity) {
    ...
    return HSVColor.fromAHSV(
      ...
      0.6,
      0.9,
    ).toColor().withValues(alpha: opacity);
  }
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (shootT > 0 && shootT < 1) {
      ...
      canvas.drawCircle(
        ...
        1.5,
        Paint()
          ..color = Colors.white.withValues(alpha: math.sin(shootT * math.pi)),
      );
    }
    ...
    canvas.drawCircle(
      ...
      13,
      Paint()
        ..color = cosmosTheme.nebulaColors[0].withValues(alpha: pulseOp)
    ...
    canvas.drawCircle(
      ...
      22,
      Paint()
        ..color = cosmosTheme.nebulaColors[1].withValues(alpha: pulseOp * 0.6)
        ..style = PaintingStyle.stroke
        ..strokeWidth = 0.5,
    );
  }
